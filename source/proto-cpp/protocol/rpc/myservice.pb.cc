...
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_rpc_2fmyservice_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_rpc_2fmyservice_2eproto = nullptr;

const uint32_t TableStruct_rpc_2fmyservice_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 8, -1, -1, sizeof(::myservice::HelloReply)},
};
...
const char descriptor_table_protodef_rpc_2fmyservice_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "oto3"
  ;
static ::_pbi::once_flag descriptor_table_rpc_2fmyservice_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_rpc_2fmyservice_2eproto = {
    false, false, 204, descriptor_table_protodef_rpc_2fmyservice_2eproto,
    "rpc/myservice.proto",
    &descriptor_table_rpc_2fmyservice_2eproto_once, nullptr, 0, 2,
    schemas, file_default_instances, TableStruct_rpc_2fmyservice_2eproto::offsets,
    file_level_metadata_rpc_2fmyservice_2eproto, file_level_enum_descriptors_rpc_2fmyservice_2eproto,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_rpc_2fmyservice_2eproto(&descriptor_table_rpc_2fmyservice_2eproto);
namespace myservice {
