...
CREATE TABLE `charbase` (
  ...
  `exploit` int(10) unsigned NOT NULL COMMENT '功勋点',
...
CREATE TABLE `friends` (
  ...
  `teamname` varchar(14) NOT NULL,
  `oppositeid` bigint(20) unsigned NOT NULL,
  `oppositename` varchar(32) NOT NULL,
  ...
  KEY `id` (`id`),
  KEY `id_2` (`id`,`oppositeid`),
  KEY `flag` (`flag`,`oppositeid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
INSERT INTO `loginstatistics` VALUES ('3138640830', '0', '0');
INSERT INTO `loginstatistics` VALUES ('3138640830', '1', '0');
INSERT INTO `loginstatistics` VALUES ('3138640830', '2', '0');
INSERT INTO `loginstatistics` VALUES ('3138640830', '3', '0');
INSERT INTO `loginstatistics` VALUES ('3138640830', '4', '0');
INSERT INTO `loginstatistics` VALUES ('3138640830', '5', '0');
INSERT INTO `loginstatistics` VALUES ('3138640830', '6', '0');
INSERT INTO `loginstatistics` VALUES ('3138640830', '7', '0');
INSERT INTO `loginstatistics` VALUES ('3138640830', '8', '0');
INSERT INTO `loginstatistics` VALUES ('3138640830', '9', '0');
...
-- ----------------------------
-- Table structure for `sga_charbase_info`
-- ----------------------------
DROP TABLE IF EXISTS `sga_charbase_info`;
;

-- ----------------------------
-- Records of sga_charbase_info
-- ----------------------------

-- ----------------------------
-- Table structure for `sga_queue_offset`
-- ----------------------------
DROP TABLE IF EXISTS `sga_queue_offset`;
;

-- ----------------------------
-- Records of sga_queue_offset
-- ----------------------------
